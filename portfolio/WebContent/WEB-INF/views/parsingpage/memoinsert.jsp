		...
		<table border="1" width="50%" height="80%" align='center'>
			...
			<tr>
				<td rowspan="5" align="center">
					...
					<br /> <input type='file' id="imagepath" name="imagepath" /><br />
				</td>
			</tr>
			...
			<tr>
				<td align="center" colspan="3">
					...
					onclick="javascript:window.location='memo'" />
					<p></p>
				</td>
			</tr>
		</table>
...
document.getElementById("imagepath").addEventListener('change',function(){
	...
	if(this.files && this.files[0]){
		...
		*/
		...
		//파일 내용을 읽어서 수 있는 객체를 생성
		var reader = new FileReader()
		//파일의 내용을 읽기를 요청 - 자체가 비동기 요청이다.
...
document.getElementById("insertbtn").addEventListener("click", function(){
	...
	//파일전송
	formdata.append("imagepath", document.getElementById("imagepath").files[0])
	$.ajax({
		url:"memoinsert",
		data:formdata,
		dataType:"json",
